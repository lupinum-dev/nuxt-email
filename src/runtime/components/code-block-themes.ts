/**
 * Ported byte-for-byte from react-email@6.9.0
 * packages/react-email/src/components/code-block/themes.ts.
 * The 38 theme objects are reproduced verbatim; only the type header differs
 * (React.CSSProperties -> a string-valued style map, since every theme value
 * is a CSS string literal).
 */

export type CodeBlockThemeStyle = Record<string, string | undefined>

export type CodeBlockTheme = Record<string, CodeBlockThemeStyle>
