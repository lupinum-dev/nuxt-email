...
Local automated tests deliberately do not mark manual QA complete. A pre-1.0 candidate can be prepared locally, but v1 publishing approval waits on a completed client-QA record and external beta evidence.
::
