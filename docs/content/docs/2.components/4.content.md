...
The default style uses `line-height: 100%`, no text decoration, inline-block display, `max-width: 100%`, and `mso-padding-alt: 0px`. Author styles override these values.
